    ...
    <>
      <div className="flex md:flex-row flex-col-reverse  gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
        ...
        {/* Left Column */}
                        ...
                        <div className="pt-5">
                            {courseData.courseContent.map((chapter, index)=> (
                                <div key={index} className="border border-gray-300 bg-white mb-2 rounded">
                                    <div className="flex items-center justify-between px-4 p-3 cursor-pointer select-none" onClick={() => toggleSection(index)}>
                                    ...
                                    <div className={`overflow-hidden transition-all duration-500  ${openSection[index] ? 'max-h-96' : 'max-h-0' } ease-in-out`}>
          ...
          {/* Righ Column */}
          <div className=" max-w-[524px] z-10 drop-shadow-xl rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]">
        {
            playerData ? 
            ...
            <div className="p-5">
                ...
                <div className="flex gap-3 items-center pt-2">
                    ...
                    <p className="md:tex-lg text-gray-500 line-through">{currency}{courseData.coursePrice}</p>
                ...
                <button className="md:mt-6 mt-4 w-full py-3 rounded- bg-blue-600 text-white font-medium cursor-pointer">{isAllreadyEnrolled ? 'Allready Enrolled' : 'Enroll Now'}</button>
                ...
                <div className="pt-6">
                    ...
                    <ul className="ml-4 pt-2 text-sm md:text-base list-disc text-gray-500">
                        ...
                        <li>Downloadable resoureces and Documents.</li>
                        <li>Quizzers to test you knowledge</li>
