...
const CallToAction = () => {
    return (
        <div className="flex flex-col items-center gap-4 pt-10 pb-24 px8 md: px-0">
            ...
            <div className="flex items-center font-medium gap-6 mt-4">
                ...
                <button className="flex items-center gap-2">Learnmore <img src={assets.arrow_icon} alt="arrow_icon" /></button>
            </div>
        </div>
    );
};
